    const falling_stuff_namespace = function () { // use a function to hide all the identifiers except start_game and stop_game
        ...
        function bullet_collision(some_falling_box, bullet) {
            ...
            if (
                ...
                console.log("DEBUGL: BULLET ", bullet, "HIT ", some_falling_box)
        ...
        var the_bullets = { // an object with an array of boxes and two functions to add boxes to the array
            ...
            add_bullet: function () {
                ...
                this.bullets.push( new Bullet( x, y, dy, mass, "#000000") )
            },
        }
        ...
        function start_game() {
            game_interval = setInterval(game_loop, 30)
        }
        ...
        function game_loop() {
            ...
            for (i=0; i<the_falling_boxes.falling_boxes.length; i++) {
                ...
                if ( (the_falling_boxes.falling_boxes[i].dy == 0)
                    ...
                    if (debug) {console.log("DEBUG: BOX SPLICED");}
                }
            } 
                ...
                if (  //delete this chunk if its broken 
                    (the_bullets.bullets[j].y > canv.height)
                ) {
                    the_bullets.bullets.splice( j, 1 );
                    if (debug) {console.log("DEBUG: BULLET SPLICED");}
                }
            ...
            draw_everything();
            if (debug) {console.log("DEBUG: END LOOP");}
        }
