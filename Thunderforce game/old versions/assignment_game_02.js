    const falling_stuff_namespace = function () { // use a function to hide all the identifiers except start_game and stop_game
        ...
        function Box(x, y, width, height, colour, health) {
            this.x = x;
            this.y = y;
            this.width = width;
            this.height = height;
        ...
        var me = new Box(canv.width/2, canv.height-30, 30, 20, "#f00", 3);
        ...
        function fire( e ) {
           e.preventDefault();
            ...
            if (debug) {console.log("Bullets in array:" + the_bullets.bullets.length)}
        }
        ...
        function was_i_hit(some_falling_box) {
            ...
            if (
                ...
                some_falling_box.health -= 3;
                    ...
                    if (debug) {console.log(me.health, "HIT", some_falling_box, "at", some_falling_box.y)} else {
                        stop_game()
                    }
        ...
        function bullet_collision(some_falling_box, bullet) {
            ...
            if (
                ...
                console.log(bullet + "HIT " + some_falling_box)
        ...
        var the_bullets = { // an object with an array of boxes and two functions to add boxes to the array
            ...
            add_bullet: function () {
                ...
                this.bullets.push( new Bullet( x, y, dy, "#000000") )
            },
        }

        /* constructor for creating new bullets */
        function Bullet( x, y, dy, colour ) {
            this.x = x;
            this.y = y;
            this.dy = dy;
            this.colour = colour;
        ...
        function Falling_box( x, y, dy, mass, colour, health ) {
            this.x = x;
            this.y = y;
            this.dy = dy;
            this.mass = mass;
        ...
        var the_falling_boxes = { // an object with an array of boxes and two functions to add boxes to the array
            ...
            add_random_falling_box: function () {
                ...
                this.falling_boxes.push( new Falling_box( x, y, dy, mass, "#000000", 3) )
            },
        ...
        function game_loop() {
            ...
            for (j = 0; j<the_bullets.bullets.length; j++) {
                bullet_collision(the_falling_boxes.falling_boxes[i], the_bullets.bullets[j]);
                the_bullets.bullets[j].update_position();
                
                if ( (the_bullets.bullets[j].dy == 0)
                    || (the_bullets.bullets[j].y + 20 < canv.height)
                ) {
                    the_bullets.bullets.splice( j, 1 );
                }

                if (debug){console.log(the_bullets.bullets.length);}
                console.log(the_bullets.bullets[j].y);
